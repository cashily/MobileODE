...
from cvnets.models.classification.config.mobilenetv1_ode import get_configuration
from utils.math_utils import bound_fn
from cvnets.modules import InvertedResidual_ode

@MODEL_REGISTRY.register(name="mobilenetv1_ode", type="classification")
class MobileNetv1_ode(BaseImageEncoder):
    ...
    def __init__(self, opts, *args, **kwargs) -> None:
        ...
        self.layer_2, out_channels = self._make_ode_layer(image_size,image_size,3,  #10
        ...
        self.layer_3, out_channels = self._make_ode_layer(image_size,image_size,3,  #10
        ...
        self.layer_4, out_channels = self._make_ode_layer(image_size,image_size,3,  #10
            opts=opts,
        ...
        input_channels = out_channels
        image_size//=2
        self.layer_5, out_channels = self._make_ode_layer(image_size,image_size,3,  #10
            opts=opts,
