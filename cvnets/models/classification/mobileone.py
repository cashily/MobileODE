...
class MobileOne(BaseImageEncoder):
    ...
    def __init__(self, opts, *args, **kwargs) -> None:
        ...
        self.layer_2 = self._make_stage(0,
        ...
        self.layer_3 = self._make_stage(0,
        ...
        self.layer_4 = self._make_stage(1,
        ...
        self.layer_5 = self._make_stage(1,
    ...
    def _make_stage(
        self, flag: int, planes: int, num_blocks: int, num_se_blocks: int
    ) -> nn.Sequential:
