...
from cvnets.models.classification.config.mobilevit_ode import get_configuration
...
@MODEL_REGISTRY.register(name="mobilevit_ode", type="classification")
class MobileViT(BaseImageEncoder):
    ...
    def __init__(self, opts, *args, **kwargs) -> None:
        ...
        image_size//=4
        in_channels = out_channels
        self.layer_2, out_channels = self._make_ode_layer(image_size,image_size,60,
            opts=opts, input_channel=in_channels, mv1_config=mobilevit_config["layer2"]
        )
        self.model_conf_dict["layer2"] = {"in": in_channels, "out": out_channels}
        image_size//=2
        in_channels = out_channels
        self.layer_3, out_channels = self._make_ode_layer(image_size,image_size,30,
    ...
    def _make_layer(
        ...
        **kwargs
        ...
        if block_type.lower() == "mobilevit_ode":
